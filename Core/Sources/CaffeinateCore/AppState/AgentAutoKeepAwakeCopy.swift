...
// follow — copy for a behaviour lives in CaffeinateCore, next to the behaviour,
...
public enum AgentAutoKeepAwakeCopy {
    ...
    public static let menuHelp = """
        ...
        as soon as the agent is waiting on you. Turn it off and Caffeinate \
    ...
    public static let settingsFooter = """
        On by default. Turn it off and Caffeinate ignores coding agents \
