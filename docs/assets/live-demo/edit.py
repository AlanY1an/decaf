...
steps = [('run_agent_clicked', .65, 2), ('working_menu_opened', 1.0, 3),
         ('monthly_usage_opened', .95, 3), ('monthly_card_preview_opened', .95, 3),
         ('save_panel_opened', 1.1, 2), ('png_saved', .95, 3)]
filters = []
...
# The 30px system menu-bar strip contains unrelated status items. The native dropdown
# below it is retained. The demo application's statistics and save dialog are untouched.
