...
//   Tests/DecafCoreTests/Fixtures/ (02-1 gate; see Fixtures/README.md for
...
/// One hook stdin fixture, read the way decaf-bridge reads real hook stdin:
...
@Suite struct DetectionTests {
    ...
    @Suite struct SixEventMapping {
        ...
        /// fields decaf-bridge extracts, under exactly the plan's names.
        @Test(arguments: [
    ...
    @Suite struct Persistence {
        ...
        private func temporaryFileURL() -> URL {
            FileManager.default.temporaryDirectory
                .appendingPathComponent("decaf-detection-tests-\(UUID().uuidString)", isDirectory: true)
